    ...
    def __init__(me, app, **config) -> None:
        ...
        class ArticleCompletion(AutoRegressiveDecoder):
            ...
            def predict(self, inputs, output_ids, states):
                ...
                return self.last_token(me.model).predict(token_ids)
            ...
            class Implementation(DataSourceStage.Implementation):
                ...
                def __init__(self, dataset_name, prompts, n=5, topp=0.9):
                    ...
                    def relative(filename):
                        return expand_path(
                            f'models_data/autocompletion/{filename}')
                    ...
                    self.article_completion.tokenizer = Tokenizer(
                        dict_path, do_lower_case=True)
